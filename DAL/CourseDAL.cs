...
namespace Cursach.DAL
{
    public class CourseDAL : ICourseDAL
    {
        ...
        public void AddCourse(Course course)
        {
            ...
            {
                conn.Open();
                MySqlCommand cmd = new MySqlCommand("INSERT INTO course (Title, Description, Price, InstructorID, Theme) VALUES (@title, @description, @price, @instructorId, @theme)", conn);
